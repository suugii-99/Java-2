  ...
  // Task 1: Use console.log() to print the months array. Notice how the first month is fixed!
     console.log("Task 1: Updated Months Array:", months);
  ...
  // months array.
     months[4] = "May"; // Set the 5th element to "May"
     months[5] = "Jun"; // Set the 6th element to "Jun"
     console.log("Task 2: Corrected Months Array:", months);
  ...
  // of items in the months array. (Docs: https://www.w3schools.com/js/js_arrays.asp)
     console.log("Task 3: Number of Months:", months.length);
  ...
  // to print the array to the console. Check the docs for more information on .push().
    months.push("Dec");
    console.log("Task 4: Added December:", months);
  ...
  // the last item from the array and then print the months array using console.log()
    months.pop();
    console.log("Task 5: After Removing Last Month:", months);
  ...
  // number of items you'd like to delete. Use .splice() to remove "Jul" from the months array.
     const indexOfJul = months.indexOf("Jul"); // Find the index of "Jul"
     if (indexOfJul !== -1) {
      months.splice(indexOfJul, 1); // Remove "Jul"
     }
     console.log("Task 6: After Removing 'Jul':", months);
